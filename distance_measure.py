...
# Function to calculate focal length in pixels from the
# field of view and resolution width
...
RW = 530  # Resolution Width in pixels

# Constants
KNOWN_WIDTH = 51  # Approximate shoulder width of an adult in cm
...
# and instances_recorded < max_instances
while cap.isOpened():
